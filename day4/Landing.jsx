          ...
          <div style={{backgroundColor:"rgb(0, 0, 0,0.3)", height:520,width:"100%", display: "flex", justifyContent: "center", alignItems: "center"}}>
              <div><center>
                ...
                <div className="flex gap-6">
                  <a className="inline-block mx-3 my-10 px-5 py-2 text-sm font-l font-semibold text-gray-700 border-2 bg-white border-white hover:bg-transparent hover:text-white focus:outline-none focus:ring">
                    LOGIN
                  </a>
